...
function NavBarLinks() {
    ...
    return ( 
        <ul className="hidden md:flex gap-10 text-slate-600 w-[330px] ml-[105px]">
          ...
          <li className='group transition-all duration-300 ease-in-out'><Link className={`hover:text-pink-200 focus:text-pink-300 bg-left-bottom bg-gradient-to-r from-pink-300 to-pink-300 bg-[length:0%_2px] bg-no-repeat group-hover:bg-[length:100%_2px] transition-all duration-500 ease-out ${router.pathname == "/contact" ? "text-pink-300" : "text-gray-600"}`} href='/contact'>Contact</Link></li>    
      </ul>
