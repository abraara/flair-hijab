...
function MobileMenuButton() {
  ...
  <div className={`top-[100px] right-0 fixed bg-white border-x-2 w-[80vw] sm:w-[60vw] md:w-[25vw] h-full p-1 z-10 ${isOpen ? 'translate-x-0' : 'translate-x-full'} ease-in-out duration-300`}>         
