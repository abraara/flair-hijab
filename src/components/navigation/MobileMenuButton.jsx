    ...
    <svg version="1.0" xmlns="http://www.w3.org/2000/svg"
      ...
      <ul className="justify-center flex gap-3 pb-[140px]">
         ...
         <li>
            ...
            <button aria-label="instagram" id="instagram-side" class=" border-2 hover:border-0 border-pink-500 bg-gradient-to-b text-2xl hover:from-indigo-600 hover:via-pink-600 hover:to-yellow-500 min-w-wull hover:text-white bg-white text-pink-600 w-10 h-10  transform hover:-translate-y-3 rounded-full duration-500 ">
         ...
         <li>
            ...
            <button aria-label="tiktok" id="tiktok-side" class="bg-white transform hover:-translate-y-3 border-2 w-10 h-10 rounded-full duration-500 text-black border-black hover:bg-black hover:text-white text-2xl">
